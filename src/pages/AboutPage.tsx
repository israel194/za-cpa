      ...
      <section className="relative bg-white py-16 md:py-20">
        <div className="mx-auto max-w-4xl px-6 md:px-10">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <Link
              to="/team"
              className="inline-flex items-center gap-2 rounded-full bg-rose-gold-500 px-6 py-3 text-sm font-semibold text-white shadow-[0_8px_24px_-8px_rgba(183,110,121,0.6)] transition-all hover:-translate-y-0.5 hover:bg-rose-gold-600"
            >
              {t('about.meetTeam')}
              <Arrow size={16} />
            </Link>
