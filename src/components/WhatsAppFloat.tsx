...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 start-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-rose-gold-500 text-white shadow-[0_18px_40px_-8px_rgba(183,110,121,0.7)] transition-all duration-300 hover:-translate-y-1 hover:bg-rose-gold-600 hover:shadow-[0_22px_48px_-8px_rgba(183,110,121,0.85)] focus:outline-none focus:ring-4 focus:ring-rose-gold-300/50"
    >
