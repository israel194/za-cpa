    ...
    >
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-lg text-ink-700">{t('services.subtitle')}</p>
        </div>
          ...
          {standardServices.map((service) => {
            ...
            return (
              <Link
                ...
                className="group relative overflow-hidden rounded-2xl border border-blush-100 bg-white p-7 transition-all duration-300 hover:-translate-y-1 hover:border-rose-gold-300 hover:shadow-[0_24px_48px_-24px_rgba(183,110,121,0.4)]"
              >
                <div
                  aria-hidden
                  className={`absolute -top-10 h-32 w-32 rounded-full bg-blush-100/0 transition-colors duration-300 group-hover:bg-blush-100/70 ${
